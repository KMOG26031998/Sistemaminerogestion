...
//            response.getWriter().println("<h3>File " + fileName + " Is Not Present .....!</h3>");
            JOptionPane.showMessageDialog(null, "NO HAY ARCHIVO PARA VISUALIZARLO: INGRESE UN DOCUMENTO EN EL MENU DE SUBIR CURRICULUM.");
            response.sendRedirect("HistorialPostulante.jsp");
