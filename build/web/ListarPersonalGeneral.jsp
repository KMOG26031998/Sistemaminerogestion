...
<html>
    <head>
        ...
        <link href="css/Listarpostulantegeneral.css" rel="stylesheet" type="text/css"/>
    ...
    <body >      
        <%
            ...
            rs = smt.executeQuery("select idpersonalcontratado as codigo, postulante_dni as cedula, fechaingreso as fecha, motivoingreso as motivo from personalcontratado where cargararchivocv is not null and personal_user = '" + session.getAttribute("personal_user11") + "'");
            //Creamo la Tabla:     
        %>
                        ...
                        <tbody id="tbodys">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="ActualizarCurriculo.jsp?codigo=<%= rs.getInt("codigo")%>" class="btn btn-primary">Seleccionar Personal</a>
                                </td>
                            </tr>
                            <%}%>
                    </table>
